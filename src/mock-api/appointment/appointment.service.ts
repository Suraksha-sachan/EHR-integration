    ...
    async getNextAppointment(){
        return {
            "link": [
              {
                "relation": "self",
                "url": "https://dev-integration.bots.docsink.com/api/mock-api/fhir/Appointment?_count=10"
              }
            ],
            "entry": [
              {
                "resource": {
                  ...
                  "description": "CCA - Initial",
                  "start": "2023-05-18T10:00:00.000-04:00",
                  "end": "2023-05-20T15:00:00.000-04:00",
                  "minutesDuration": 30,
                  "slot": [
                    {
                      "reference": "Slot/60914285"
                    }
                  ],
                  "participant": [
                    {
                      "actor": {
                        "reference": "Patient/19461035752"
                      }
                    },
                    {
                      "type": [
